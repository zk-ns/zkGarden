#[starknet::contract]
mod ERC721 {
    use zkGarden::chick::interface::DualCaseSRC5DispatcherTrait;
    use zkGarden::chick::interface::DualCaseSRC5Dispatcher;
    use zkGarden::chick::interface::DualCaseERC721ReceiverDispatcherTrait;
    use zkGarden::chick::interface::DualCaseERC721ReceiverDispatcher;
    use zkGarden::chick::interface;
    ...
    impl ERC721Impl of interface::IERC721<ContractState> {
        ...
        fn free_mint(ref self: ContractState, to: ContractAddress){
            let caller = get_caller_address();
    ...
    impl ERC721CamelOnlyImpl of interface::IERC721CamelOnly<ContractState> {
        fn tokenUri(self: @ContractState, tokenId: u256) -> Array<felt252> {
            ERC721Impl::token_uri(self, tokenId)
        }
